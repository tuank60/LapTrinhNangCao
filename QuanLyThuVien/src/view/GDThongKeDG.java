...
public class GDThongKeDG extends javax.swing.JFrame {
    ...
    public GDThongKeDG() {
        ...
        // Load luôn dữ liệu thống kê độc giả theo lớp học lên Table
        myConn = new MyConnect();
        String sql = "SELECT lop,COUNT(lop) AS Count FROM quanlythuvien.docgia GROUP BY lop";
        try {
            ...
            cols.add("Lớp học");
            cols.add("Số lượng độc giả");
            while (rs.next()) {

                Vector s = new Vector();
                s.add(rs.getString("lop"));
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Theo lớp học" }));
            ...
            if (returnVal == javax.swing.JFileChooser.APPROVE_OPTION) {
                try {
                    ...
                    if (f.exists()) {
                        ...
                        Paragraph p = new Paragraph("THỐNG KÊ ĐỘC GIẢ", f2);
                        ...
                        if (jComboBox1.getSelectedIndex() == 0) {
                            Paragraph p5 = new Paragraph("Thống kê độc giả theo lớp học\n\n", f6);
                            p5.setAlignment(Element.ALIGN_LEFT);
                            document.add(p5);
                            PdfPCell c11 = new PdfPCell(new Phrase("Lớp học", f7));
                            t1.addCell(c11);
                            PdfPCell c12 = new PdfPCell(new Phrase("Số lượng độc giả", f7));
                            t1.addCell(c12);
                        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GDThongKeDG.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GDThongKeDG().setVisible(true);
            }
        });
    }
